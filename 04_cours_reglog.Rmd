...
3. Pour chaque groupe d’observations $G_k$ , on compare le nombre de sujets pour lesquels $Y=1$ ($n_{1k}$), à la somme les $\mathbb{P}(Y=1)$ ($\widehat{n}_{1k}$). De même on calcul $n_{0k}$ et $\widehat{n}_{0k}$.

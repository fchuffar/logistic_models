...
Pour les modèles linèaires on définissait le $R^2$ comme le pourcentage de variance expliqué par le modèle.
...
3. Pour chaque groupe d’observations $G_k$ , on compare le nombre de sujets pour lesquels $Y=1$ ($n_{1k}$), à la somme les $\mathbb{P}(Y=1)$ ($\widehat{n}_{1k}$). De même on calcul $n_{0k}$ et $\widehat{n}_1k$.
...
**AUC** signifie *aera under the curbe*, *i.e*, l’aire sous la courbe ROC.

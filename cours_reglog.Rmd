...
Séance 2 - 3h  Variable explicative quantitaive

Séance 3 - 3h  Data Challenge

Séance 4 - 3h  Modèle de comptage, Régression de Poisson
...
```{r child = '01_cours_reglog.Rmd', eval=FALSE}
```

```{r child = '02_cours_reglog.Rmd', eval=FALSE}
```

```{r child = '03_cours_reglog.Rmd', eval=FALSE}
```

```{r child = '04_cours_reglog.Rmd', eval=FALSE}
```

```{r child = '05_cours_reglog.Rmd', eval=FALSE}
```
